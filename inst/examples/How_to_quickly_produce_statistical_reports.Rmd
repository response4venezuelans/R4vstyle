...
title: "How to quickly produce reproducible statistical reports?"
...
abstract: "This R cookbook is designed to make the process of creating publication-ready graphics and reports with UNHCR style a more __reproducible process__. As the styling is already built-in through [unhcRstyle](https://unhcr-web.github.io/unhcRstyle/docs/) package, users will be able to save time and focus on analysis narrative rather than on technical configuration. It shall support anyone who wants to make advanced graphics and gain efficiency in the generation of statistical reports."
...
output: 
  unhcRstyle::unhcr_templ_paged: 
    ...
    front_cover: img/cover_placeholder_blue.jpg
...
```{r preparedata, message=FALSE, warning=FALSE, cache=TRUE}
...
#st_crs(world$geometry) <- '+init=epsg:4326'  
...
Information Management Officer / UNHCR

[vidonne@unhcr.org](mailto:vidonne@unhcr.org)
:::

::: {.back-contact}
[Edouard Legoupil]{.back-name}

Snr Data Analysis Officer / UNHCR

[legoupil@unhcr.org](mailto:legoupil@unhcr.org)
:::
